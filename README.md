...
**[hello rails frontend ]** is make the hello world for the fullstack app with react to fetch the data from api.
...
Feel free to check the [[issues page](https://github.com/soesandarwin2201/hello-rails-frontend/issues)]
